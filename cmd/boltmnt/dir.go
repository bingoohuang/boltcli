...
func (fakeBucket) Get(key []byte) []byte              { return nil }
func (fakeBucket) Put(key []byte, value []byte) error { return fuse.EPERM }
func (fakeBucket) Delete(key []byte) error            { return fuse.EPERM }
